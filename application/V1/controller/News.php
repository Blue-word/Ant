...
class News extends Common{
    ...
    public function contentDet(){
        ...
        $url = 'http://localhost/jraz/index.php/admin/news/test/id/{$id}';
        //$id = 50;
    ...
    public function advertising(){
        ...
        foreach ($res as $k => $v) {
            if ($v['picture'] !== '') { //picture为空则不处理
                $res[$k]['picture'] = img_url_transform($v['picture'],'absolute');//组装地址
            }
        }
        dump($res);
        //$this->apiReturn('查询成功','200',$res);
